...
import com.app.infideap.postingapp.fragment.CommentFragment.OnListFragmentInteractionListener;
...
public class CommentRecyclerViewAdapter extends RecyclerView.Adapter<CommentRecyclerViewAdapter.ViewHolder> {
    ...
    public CommentRecyclerViewAdapter(List<Post> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
